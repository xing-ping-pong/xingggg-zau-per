// This script is designed to run on Vercel or with a remote MongoDB connection
// Run this with: node scripts/seed-pages-vercel.js
...
async function createPages() {
  ...
  const adminToken = process.env.ADMIN_TOKEN // You'll need to set this in your environment
